...
const translations: { [key: string]: { [key: string]: string } } = {
  en: {
    ...
    // New translations for improved cards page
    totalHourlyEarnings: 'Total Hourly Earnings',
    collectRewards: 'Collect Rewards',
    collecting: 'Collecting...',
    shroukBalance: 'SHROUK Balance',
  ...
  ar: {
    ...
    // New translations for improved cards page
    totalHourlyEarnings: 'إجمالي الأرباح بالساعة',
    collectRewards: 'جمع المكافآت',
    collecting: 'جاري الجمع...',
    shroukBalance: 'رصيد شروق',
  ...
  ru: {
    ...
    // New translations for improved cards page
    totalHourlyEarnings: 'Общий доход в час',
    collectRewards: 'Собрать награды',
    collecting: 'Сбор...',
    shroukBalance: 'Баланс SHROUK',
    purchaseCard: 'Купить карту',
    upgradeCard: 'Улучшить карту',
    purchasing: 'Покупка...',
    upgrading: 'Улучшение...',
    perHour: 'в час',
    ...
    cardPurchased: 'Карта куплена!',
    cardUpgraded: 'Карта улучшена!',
    purchaseFailed: 'Покупка не удалась',
    upgradeFailed: 'Улучшение не удалось',
    ownedCard: 'Принадлежит',
